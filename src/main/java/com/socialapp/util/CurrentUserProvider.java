...
//            throw new RuntimeException("Authorization header isn't found or invalid!");
            throw new NotFoundException("Authorization header isn't found or invalid!");
        }
...
//        Token savedToken = tokenRepository.findByToken(token).orElseThrow(() -> new RuntimeException("Token isn't found"));
        Token savedToken = tokenRepository.findByToken(token).orElseThrow(() -> new NotFoundException("Token isn't found"));
